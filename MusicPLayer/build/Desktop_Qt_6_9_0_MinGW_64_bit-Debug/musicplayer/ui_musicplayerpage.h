...
public:
    ...
    void setupUi(QMainWindow *musicplayerpage)
    {
        ...
        actionrepeat_playlist = new QAction(musicplayerpage);
        actionrepeat_playlist->setObjectName("actionrepeat_playlist");
...
"font: 300 10pt \"Sultan Free\";"));
        ...
        time->setOrientation(Qt::Orientation::Horizontal);
        ...
        volum->setOrientation(Qt::Orientation::Horizontal);
        ...
        menuRepeat_mode->addAction(actionrepeat_playlist);
    ...
    void retranslateUi(QMainWindow *musicplayerpage)
    {
        ...
        actionDon_t_repeat->setText(QCoreApplication::translate("musicplayerpage", "Don't repeat playlist", nullptr));
        ...
        actionexit_2->setText(QCoreApplication::translate("musicplayerpage", "Quit", nullptr));
        actionrepeat_playlist->setText(QCoreApplication::translate("musicplayerpage", "repeat playlist", nullptr));
