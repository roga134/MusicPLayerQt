...
template <> constexpr inline auto MyTcpServer::qt_create_metaobjectdata<qt_meta_tag_ZN11MyTcpServerE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'onReadyRead'
        QtMocHelpers::SlotData<void(QTcpSocket *)>(14, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { 0x80000000 | 15, 16 },
        }}),
        // Slot 'onDisconnected'
...
void MyTcpServer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 4: _t->playSpecificSongRequested((*reinterpret_cast< std::add_pointer_t<QString&>>(_a[1]))); break;
        case 5: _t->onNewConnection(); break;
        case 6: _t->onReadyRead((*reinterpret_cast< std::add_pointer_t<QTcpSocket*>>(_a[1]))); break;
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        if (QtMocHelpers::indexOfMethod<void (MyTcpServer::*)(const QStringList & )>(_a, &MyTcpServer::updateDeviceList, 3))
            return;
        if (QtMocHelpers::indexOfMethod<void (MyTcpServer::*)(QString & )>(_a, &MyTcpServer::playSpecificSongRequested, 4))
            return;
    }
}
...
// SIGNAL 4
void MyTcpServer::playSpecificSongRequested(QString & _t1)
{
