...
void SignUp::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (SignUp::*)()>(_a, &SignUp::downPressed, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (SignUp::*)()>(_a, &SignUp::upPressed, 1))
            return;
    }
}
...
// SIGNAL 0
void SignUp::downPressed()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void SignUp::upPressed()
{
